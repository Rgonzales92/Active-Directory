...
![Most important parts here are ISO Image where you select the one you downloaded, type is Microsoft unless it is something else such as Linux. Select the version you have. Check skip unattended installation for now and finish.](attachment:bc95db56-4b21-4a59-8766-db8618cc1e87:image.png)
